...
EveryAuction Release Version 1.54_f -
This is a variant(forked?) version altered 
...
mkdir auction
chmod 777 auction
(WARNING: using 777 permissions on a shared system is dangerous.  You
should tighten these permissions in a production environment so only
the script has read/write access to the data files.)
...
Line 53: This should point to the base directory (the one you just
...
Line 75: List your categories here.  Follow the examples.  Be sure
...
A. Edit line 75 of the script to point to new categories.
...
The administrator password is defined on line 84 of the script.
...
Version 1.53 - Security and bugfix release.  HTML tags now
removed from posted item descriptions to protext against malicious
JavaScript code.  Stricter e-mail address checking.  Also fixed
default bid increment problem.
